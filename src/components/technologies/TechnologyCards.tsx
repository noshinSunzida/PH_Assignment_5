    ...
    return (
         <div className="card bg-base-100 shadow-2xs border border-slate-100 rounded-2xl">
            <div className="card-body">
              ...
              <div className="flex justify-between">
                  <img src={technology.icon} alt="" className="w-7 h-7"/>
                    <span className="badge font-jakarta font-semibold text-[12px] bg-blue-300">{technology.badge}</span>
                </div>
                ...
                <div className="flex justify-between items-center mt-1">
                     <span className="bg-slate-100 text-slate-600 px-2 py-1 rounded-[4px] text-[11px] font-jakarta font-semibold">
            ...
            <span className="text-yellow-400"><FaStar /></span>{technology.rating}</span>
                  ...
                  <div>
                        <button onClick={() => {setSelectedCards([...selectedCards, technology])}} disabled ={isSelected}
